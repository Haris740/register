                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Thahreez Results</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
$qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblstudents.Marks,tblstudents.SecRank,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=:rollid and tblstudents.ClassId=:classid ";
...
{   ?>
<img src="images/<?php echo htmlentities($row->RollId);?>.JPG" alt="<?php echo htmlentities($row->RollId);?>"" height="151px" width="133px" style="border-radius:5px;" />
<p><b>Student Name :</b> <?php echo htmlentities($row->StudentName);?></p>
<p><b>Student Roll Id :</b> <?php echo htmlentities($row->RollId);?></p>
<p><b>Student Section:</b> <?php echo htmlentities($row->ClassName);?></p> 
<p><b>Total Marks:</b> <?php echo htmlentities($row->Marks);?></p>
<p><b>Section Rank:</b> <?php echo htmlentities($row->SecRank);?></p>
<?php }
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <thead>
                                                        <tr style="text-align: center">
                                                            ...
                                                            <th style="text-align: center">Rank with Grade</th>
...
<?php
echo htmlentities("Invalid AD No or Section");
 }
?>
                                        </div>
